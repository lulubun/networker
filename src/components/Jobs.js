...
class Jobs extends React.Component {
  ...
  render() {
    ...
    return (
      <div className="Jobs">
        <div className="New_Button">
          <Link to={'/' + user + '/new_Job'} className="Link"><RaisedButton className="NewButton" label="Create a New Job" fullWidth={true} backgroundColor="#5D576B" labelColor="#F1F1EF" style={{zIndex: 5, borderRadius: 0}}/></Link>
        </div>
