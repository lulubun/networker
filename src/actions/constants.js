...
export const INDI_UPDATE = 'INDI_UPDATE';

// export const SER_URL = 'https://warm-harbor-59021.herokuapp.com';
// export const APP_URL = 'https://be-a-networker.herokuapp.com';

export const SER_URL = 'http://localhost:8080';
