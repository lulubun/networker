...
app.put('/one_contact:id', (req, res) => {
  ...
  const updated = {};
  const updatableFields = ['serNextContact', 'serFirst', 'serLast', 'serImportant', 'serCompany', 'serPhone', 'serEmail', 'serMeet', 'serNote', 'serDateContact', 'serTypeContact', 'serNotesContact'];
